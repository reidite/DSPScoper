...
DigitalFilter::MainFrame::MainFrame()
					: wxFrame(nullptr, wxID_ANY, MAINFRAME_NAME, wxDefaultPosition, wxSize(MAINFRAME_WIDTH, MAINFRAME_HEIGHT)) {
	...
	originalMFSignalData = new Calc::Signal(originalATSignalData);
